...
const About = () => (
  <div className="min-h-screen pt-20 bg-background">
    ...
    <section className="relative overflow-hidden h-[70vh] flex items-center">
      ...
      {/* Decorative Elements */}
      <div className="absolute bottom-10 left-10 text-white/10 text-[120px] font-black leading-none select-none z-0">
        1970
      </div>
      <div className="absolute top-20 right-20 w-64 h-64 border border-white/10 rounded-full z-0" />
      <div className="absolute bottom-20 right-40 w-32 h-32 border border-white/10 rounded-full z-0" />
    </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <ScrollReveal>
            <div className="relative">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/60 text-sm">Quality Certified Since 2000</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Decorative Pattern */}
              <div className="absolute -z-10 -bottom-6 -right-6 w-64 h-64 border-8 border-amber/10 rounded-3xl" />
            </div>
          </ScrollReveal>

          <ScrollReveal delay={0.2}>
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 bg-amber/10 px-4 py-2 rounded-full">
                <span className="w-2 h-2 rounded-full bg-amber animate-pulse" />
                <span className="text-amber text-sm font-semibold tracking-wide">Five Decades of Excellence</span>
              </div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                ...
                <span className="text-amber relative">
                  1970
                  <span className="absolute bottom-1 left-0 w-full h-3 bg-amber/20 -z-10" />
                </span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Manufacturing Facility</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-amber/10 flex items-center justify-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {facilities.map((item, index) => (
            <ScrollReveal key={item.title} delay={index * 0.1}>
              <div className="bg-white rounded-2xl p-6 text-center border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 group">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-amber/10 flex items-center justify-center group-hover:bg-amber/20 transition-colors">
    ...
    <section className="bg-gradient-to-r from-[#5a0e1a] to-[#7a1f2b] relative overflow-hidden py-12">
      <div 
          ...
          {milestones.map((item, index) => (
            <ScrollReveal key={item.label} delay={index * 0.1}>
              <div className="text-center group">
                <div className="w-14 h-14 mx-auto mb-3 rounded-xl bg-white/10 flex items-center justify-center group-hover:bg-amber/20 transition-all duration-300">
            ...
            <ScrollReveal key={member.title} delay={index * 0.1}>
              <div className="bg-white rounded-2xl p-6 text-center border border-gray-200 shadow-lg">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-amber/10 flex items-center justify-center">
                  <member.icon className="w-7 h-7 text-amber" />
                </div>
                <div className="text-2xl font-bold text-gray-900 mb-1">{member.name}</div>
          ...
          {timeline.map((item, i) => (
            <ScrollReveal key={item.year} delay={i * 0.1}>
              <div className={`relative flex items-start gap-6 mb-10 ${i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}>
                ...
                <div className="absolute left-4 md:left-1/2 w-3 h-3 rounded-full bg-amber -translate-x-1.5 mt-2" />
                <div className="ml-10 md:ml-0 md:w-1/2 bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                  <span className="text-amber font-bold text-lg">{item.year}</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {partners.map((partner, index) => (
            <ScrollReveal key={partner} delay={index * 0.05}>
              <div className="bg-gray-50 p-4 text-center rounded-lg border border-gray-200 hover:border-amber/50 hover:bg-amber/5 transition-all duration-300">
    ...
    <section className="section-padding bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="text-amber text-sm font-semibold tracking-[0.3em] uppercase mb-2 block">What Drives Us</span>
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((v) => (
            <StaggerItem key={v.title}>
              <div className="group relative h-[380px] rounded-2xl overflow-hidden cursor-pointer shadow-xl">
                <img 
                  src={v.image} 
                  alt={v.title} 
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  <div className="w-14 h-14 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center mb-4 border border-white/20 group-hover:bg-amber/20 group-hover:border-amber/50 transition-all duration-300">
                    <v.icon className="w-6 h-6 text-white group-hover:text-amber transition-colors duration-300" />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-amber transition-colors duration-300">
                    {v.title}
                  </h3>
                  <div className="w-12 h-0.5 bg-amber/50 mb-3 transition-all duration-500 group-hover:w-20 group-hover:bg-amber" />
                  ...
                  <div className="absolute top-4 right-4 w-8 h-8 border-t-2 border-r-2 border-white/20 group-hover:border-amber/50 transition-colors duration-300" />
                </div>
              </div>
            </StaggerItem>
          ))}
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900">50+ Years of Experience</h3>
                    <p className="text-sm text-gray-600">Five decades of industry expertise and continuous innovation</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-amber/10 flex items-center justify-center shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Rigorous testing and quality control at every stage</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-amber/10 flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Tailor-made lubricant blends for unique applications</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl p-6 shadow-2xl border border-gray-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-600">Every batch tested</div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section className="relative overflow-hidden py-24">
      ...
      <div className="relative max-w-4xl mx-auto text-center px-6">
        <ScrollReveal>
          <span className="text-amber text-sm font-semibold tracking-[0.3em] uppercase mb-4 block">Partner With Us</span>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Ready to experience the{' '}
            <span className="text-amber">Tolani</span> difference?
          </h2>
          <p className="text-white/80 text-lg mb-10 max-w-2xl mx-auto">
            Join 500+ industrial clients who trust us for their critical lubrication needs
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-amber text-gray-900 font-semibold rounded-full hover:bg-amber/90 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-amber/30">
              Get in Touch
            </button>
      ...
      <div className="absolute bottom-10 left-10 w-40 h-40 bg-amber/5 rounded-full blur-3xl animate-pulse" />
      <div className="absolute top-10 right-10 w-60 h-60 bg-amber/10 rounded-full blur-3xl animate-pulse" />
    </section>
  </div>
);
